# Generated by Django 3.2.15 on 2023-06-06 20:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.address', verbose_name='Адрес')),
                ('user', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to=settings.AUTH_USER_MODEL, verbose_name='Покупатель')),
            ],
            options={
                'verbose_name': 'Заказ',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to=backend.models.shop_pricelist_dir_path, verbose_name='Файл')),
                ('update_dt', models.DateField(blank=True, null=True, verbose_name='Дата сообщения об обновлении прайс-листа')),
                ('is_uptodate', models.BooleanField(default=False, verbose_name='Актуальность прайс-листа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('min_sum', models.IntegerField(default=0, verbose_name='Минимальная сумма')),
                ('cost', models.IntegerField(verbose_name='Стоимоcть доставки')),
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivery', to='backend.shop', verbose_name='Магазин')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='delivery',
            constraint=models.UniqueConstraint(fields=('shop', 'min_sum'), name='unique_shop_min_sum'),
        ),
    ]
